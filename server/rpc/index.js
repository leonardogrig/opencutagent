...
const ENV_SPECS = [
  ...
  { key: "EDITAGENT_TRANSCRIBE_BATCH_SEC", def: "1800", desc: "Max seconds of audio bundled into one transcription upload. Ranges are concatenated so a chopped-up timeline needs only a few calls." },
